            ...
            <div class="collapse navbar-collapse" id="navbarsExample05">
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item cta-btn">
                        <a class="nav-link" style="display: flex;justify-content: center;" href="#orderSection">ORDER NOW</a>
                    </li>
                </ul>
                ...
                <div>
                    ...
                    <ul class="list-unstyled footer-link">
                        <li class="d-block">
                            ...
                            <span class="text-white">Ukraine, Zaporozhye</span></li>
                        <li class="d-block"><span class="d-block">Telephone: <small>( Telegram, Whatsapp and Viber )</small></span><span class="text-white">+380637082689</span></li>
                        <li class="d-block"><span class="d-block">Email:</span><span class="text-white">info@halalmeatinukraine.com</span></li>
                    </ul>
                </div>
            </div>
